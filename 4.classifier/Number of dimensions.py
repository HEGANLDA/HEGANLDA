...
def xgb_modle(filename_1, dis_num):
    ...
    for train_index, test_index in kf.split(data, label):
        ...
        tprs[-1][0] = 0.0
        precision_xgb_aupr, recall_xgb_aupr, _ = precision_recall_curve(Y_test, y_pred_proba)
        aupr_xgb = auc(recall_xgb_aupr, precision_xgb_aupr)
        aupr.append(aupr_xgb)
...
xgb_modle('E:\\1119\\3.lncRNA-disease_association_vector\\LDVCHN\\35ep-32dis.csv', 32)
